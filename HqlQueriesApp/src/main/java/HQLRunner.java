...
import com.vikram.spring.model.Address;
import com.vikram.spring.model.Recipes;
...
public class HQLRunner extends JFrame implements ActionListener, ListSelectionListener{
	...
	private void setResult(final List<String> lst){
	...
	public void actionPerformed(ActionEvent e) {
		this.setResult(new ArrayList<String>());
	...
	public static void main(String[] args) throws IOException {
		Configuration configuration = new Configuration();
		 ...
		 //since we are using properties file so need to map explicitly all of mapped classes here
		...
		HQLRunner runner = new HQLRunner(factory);
